...
var imgEditor = function(element){
    ...
    obj =
    {
		...
		appendTo: function(ratio) {
			...
			this.dropZone = document.getElementById('imageEditorDrop');
			this.inputZone = document.getElementById('imageEditorInput');
			this.cropZone = document.getElementById('imageEditorCanvas');
			this.imageZone = document.getElementById('imageEditorImg');
			this.previewZone = document.getElementById('imageEditorPreview');
			this.cancelBtn = document.getElementById('editorBtnCancel');
			this.deleteBtn = document.getElementById('editorBtnDelete');
			this.cropBtn = document.getElementById('editorBtnCrop');
